...
const ProductCard: React.FC<ProductCardProps> = ({ name, route, className }) => {
  ...
  return (
    <div onClick={handleClick} className={`${className} group bg-cover w-[180px] h-[148px] md:w-[300px] md:h-[260px] flex flex-col relative gap-6 rounded-lg md:rounded-2xl cursor-pointer`}>
