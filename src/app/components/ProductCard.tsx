...
const ProductCard: React.FC<ProductCardProps> = ({ name, route, className }) => {
  ...
  return (
    <div onClick={handleClick} className={`${className} group bg-product-placeholder bg-cover w-[180px] h-[148px] md:w-[450px] md:h-[300px] flex flex-col relative gap-6 rounded-lg md:rounded-2xl cursor-pointer`}>
