...
const Hero: React.FC<HeroProps> = ({ variant = 'base', firstButtonRoute = "/", secondButtonRoute = "/", title, paragraph, firstButtonText, secondButtonText, firstButtonVariant, secondButtonVariant, className, titleColor, overlay }) => {
    const router = useRouter()

    const common = (
        <div className="flex flex-col justify-center items-center text-center gap-4">
            <Text variant="headlineXl" className={`${titleColor}`}>{title}</Text>
    ...
    return (
        <>
            { variant === 'base' && (
                <section className={`${className} flex flex-col justify-center items-center h-[350px] md:h-[400px] overflow-hidden`}>
            ...
            { variant === 'single' && !overlay && (
                <section className={`${className} flex flex-col justify-center items-center h-[350px] md:h-[500px] overflow-hidden`}>
                    <div className="flex flex-col w-[342px] md:w-[674px] justify-center items-center gap-8">
                        {common}
            ...
            { variant === 'single' && overlay && (
                <section className={`${className} flex flex-col justify-center items-center h-[350px] md:h-[500px] overflow-hidden`}>
                    <div className="flex justify-center items-center bg-darkest bg-opacity-50 w-full h-full">
                        <div className="flex flex-col w-[342px] md:w-[674px] justify-center items-center gap-8">
                            {common}
                            <div className="flex flex-col md:flex-row justify-center items-center gap-6">
                                {firstButton}
            ...
            { variant === 'double' && (
                <section className={`${className} relative flex justify-center items-center h-[200px] md:h-[600px] overflow-hidden`}>
