  ...
  return (
    <section className="flex md:flex-row justify-center items-center bg-tan h-[645px] md:h-[566px] overflow-hidden">
        <div className="flex flex-col md:flex-row max-w-screen-2xl gap-12">
            ...
            <div className="grid grid-rows-2 grid-cols-2 mx-8 md:mx-2 gap-x-4">
                ...
                <div className="flex justify-center items-center row-span-2 lg:mb-1">
                    <Image className="max-w-none rounded-lg h-full object-cover w-[140px] md:w-[160px] lg:w-[200px] h-[200px] md:h-[280px] lg:h-[350px]" src="/images/cs-3.png" alt="Pizza" width={200} height={350} />
                </div>
