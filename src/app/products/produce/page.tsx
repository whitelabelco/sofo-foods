...
const Produce = () => {
    ...
    return (
        <div>
            <Header />
            <Hero variant="single" title="Produce" firstButtonVariant="blackText" firstButtonRoute="/order" firstButtonText="Place an Order" className="bg-[url('/products/produce.webp')] bg-cover bg-no-repeat bg-center" titleColor="text-white" overlay />
