...
const FrozenFreshRefrigerated = () => {
    ...
    return (
        <div>
            <Header />
            <Hero variant="single" title="Frozen / Fresh Refrigerated" firstButtonVariant="blackText" firstButtonRoute="/order" firstButtonText="Place an Order" className="bg-[url('/products/frozen-fresh-refrigerated.webp')] bg-cover bg-no-repeat bg-center" titleColor="text-white" overlay />
...
export default FrozenFreshRefrigerated;