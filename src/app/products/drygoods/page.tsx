...
const DryGoods = () => {
    ...
    return (
        <div>
            <Header />
            <Hero variant="single" title="Dry Goods" firstButtonVariant="blackText" firstButtonRoute="/order" firstButtonText="Place an Order" className="bg-[url('/products/dry-goods.webp')] bg-cover bg-no-repeat bg-center" titleColor="text-white" overlay />
