...
const BreadAndDough = () => {
    ...
    return (
        <div>
            <Header />
            <Hero variant="single" title="Bread & Dough" firstButtonVariant="blackText" firstButtonRoute="/order" firstButtonText="Place an Order" className="bg-[url('/products/bread-dough.webp')] bg-cover bg-no-repeat bg-center" titleColor="text-white" overlay />
