...
const Disposables = () => {
    ...
    return (
        <div>
            <Header />
            <Hero variant="single" title="Disposables" firstButtonVariant="blackText" firstButtonRoute="/order" firstButtonText="Place an Order" className="bg-[url('/products/disposables.webp')] bg-cover bg-no-repeat bg-center" titleColor="text-white" overlay />
