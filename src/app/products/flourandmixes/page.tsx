...
const FlourAndMixes = () => {
    ...
    return (
        <div>
            <Header />
            <Hero variant="single" title="Flour & Mixes" firstButtonVariant="blackText" firstButtonRoute="/order" firstButtonText="Place an Order" className="bg-[url('/products/flour-mixes.webp')] bg-cover bg-no-repeat bg-center" titleColor="text-white" overlay />
