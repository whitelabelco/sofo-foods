...
const TomatoProducts = () => {
    ...
    return (
        <div>
            <Header />
            <Hero variant="single" title="Tomato Products" firstButtonVariant="blackText" firstButtonRoute="/order" firstButtonText="Place an Order" className="bg-[url('/products/tomato.webp')] bg-cover bg-no-repeat bg-center" titleColor="text-white" overlay />
