...
const ProprietaryItems = () => {
    ...
    return (
        <div>
            <Header />
            <Hero variant="single" title="Proprietary Items" firstButtonVariant="blackText" firstButtonRoute="/order" firstButtonText="Place an Order" className="bg-[url('/products/proprietary-items.webp')] bg-cover bg-no-repeat bg-center" titleColor="text-white" overlay />
