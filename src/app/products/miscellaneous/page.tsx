...
const Miscellaneous = () => {
    ...
    return (
        <div>
            <Header />
            <Hero variant="single" title="Miscellaneous" firstButtonVariant="blackText" firstButtonRoute="/order" firstButtonText="Place an Order" className="bg-[url('/products/miscellaneous.webp')] bg-cover bg-no-repeat bg-center" titleColor="text-white" overlay />
