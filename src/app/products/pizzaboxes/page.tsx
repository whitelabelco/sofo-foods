...
const PizzaBoxes = () => {
    ...
    return (
        <div>
            <Header />
            <Hero variant="single" title="Pizza Boxes" firstButtonVariant="blackText" firstButtonRoute="/order" firstButtonText="Place an Order" className="bg-[url('/products/pizza-boxes.webp')] bg-cover bg-no-repeat bg-center" titleColor="text-white" overlay />
