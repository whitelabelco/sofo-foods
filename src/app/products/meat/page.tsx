...
const Meat = () => {
    ...
    return (
        <div>
            <Header />
            <Hero variant="single" title="Meat (Excludes Poultry)" firstButtonVariant="blackText" firstButtonRoute="/order" firstButtonText="Place an Order" className="bg-[url('/products/meat.webp')] bg-cover bg-no-repeat bg-center" titleColor="text-white" overlay />
