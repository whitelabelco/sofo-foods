...
const Equipment = () => {
    ...
    return (
        <div>
            <Header />
            <Hero variant="single" title="Equipment" firstButtonVariant="blackText" firstButtonRoute="/order" firstButtonText="Place an Order" className="bg-[url('/products/equipment.webp')] bg-cover bg-no-repeat bg-center" titleColor="text-white" overlay />
